 ...
 * 5. Corrigido acesso a dados de moradores com verificação de nulidade
 */
...
if ($metodo === 'GET') {
    try {
        ...
        error_log("Erro ao listar protocolos: " . $e->getMessage());
        retornar_json(false, "Erro ao listar protocolos: " . $e->getMessage());
    }
}
...
if ($metodo === 'POST') {
    try {
        ...
        error_log("Erro ao criar protocolo: " . $e->getMessage());
        registrar_log('PROTOCOLO_ERRO', "Erro ao criar protocolo: " . $e->getMessage(), 'Sistema');
        retornar_json(false, "Erro ao cadastrar protocolo: " . $e->getMessage());
    }
}
...
if ($metodo === 'PUT') {
    try {
        ...
        error_log("Erro ao atualizar protocolo: " . $e->getMessage());
        registrar_log('PROTOCOLO_ERRO', "Erro ao atualizar protocolo: " . $e->getMessage(), 'Sistema');
        retornar_json(false, "Erro ao atualizar protocolo: " . $e->getMessage());
    }
}
...
if ($metodo === 'DELETE') {
    try {
        ...
        error_log("Erro ao excluir protocolo: " . $e->getMessage());
        registrar_log('PROTOCOLO_ERRO', "Erro ao excluir protocolo: " . $e->getMessage(), 'Sistema');
        retornar_json(false, "Erro ao excluir protocolo: " . $e->getMessage());
    }
}
