...
class SessionManagerCore {
    ...
    constructor() {
        ...
        this.initializationPromise = null; // Guard contra inicializaÃ§Ãµes concorrentes
    ...
    async initialize() {
        ...
        // Evita corrida entre auto-init e init manual
        if (this.initializationPromise) {
            console.log('[SessionManager] â³ InicializaÃ§Ã£o jÃ¡ em andamento, aguardando...');
...
// Expor classe no escopo global para compatibilidade com scripts legados.
